...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = mysqli_prepare($conn, "SELECT id, firstname, lastname, email, password FROM users WHERE email = ?");
...
<head>
    ...
    <title>Sto. Tomas City Branch - Moonlight Photos</title>
...
<body>
    ...
    <div class="branch-container">
        ...
        <div class="branch-header">
            <h1 class="branch-title">SM Sto.Tomas, Batangas</h1>
            <p class="branch-address">20 Pan-Philippine Hwy, Sto. Tomas City, Batangas</p>
        </div>
